...
See: [teslamusk.site](https:/teslamusk.site).
...
**Note**: The [`main`](https://github.com/masapasa/personal-site/tree/main) branch of this repository contains a statically-exportable version of my website intended for serverless hosting on github pages. 
...
```bash
git clone git://github.com/masapasa/personal-site.git
cd personal-site
...
* [github.com/mldangelo/personal-site](github.com/mldangelo/personal-site)